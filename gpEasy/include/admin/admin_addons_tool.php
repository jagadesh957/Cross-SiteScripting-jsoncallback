...
class admin_addons_tool{
	...
	function RateForm(){
		...
		if( isset($this->addon_info['addonDir']) ){
			echo ' ('.$this->addon_info['addonDir'].') ';
		}
		echo '</h2>';
	...
	function CanRate(){
		...
		*/
		...
		if( ini_get('safe_mode') ){
			$this->messages[] = 'Your installation of PHP is in SAFE_MODE.';
		}

		/*
		if( !function_exists('fsockopen') ){
			$this->messages[] = 'The <i>fsockopen()</i> function is not available.';
		}
		*/
