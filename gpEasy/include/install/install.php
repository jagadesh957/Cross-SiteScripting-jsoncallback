...
//$jquery = common::GetDir('/include/thirdparty/js/jquery.1.6.4.js');
...
class gp_install{
	...
	function CheckFolders(){
		...
		//ctype
		$checkValue = function_exists('ctype_alnum');
		$ok = $ok && $checkValue;
		echo '<tr>';
			echo '<td>';
			echo '<a href="http://php.net/manual/en/book.ctype.php" target="_blank">';
			echo 'Character type checking';
			echo '</a>';
			echo '</td>';
			$this->StatusRow($checkValue,$langmessage['available'],$langmessage['unavailable']);
			echo '</tr>';
